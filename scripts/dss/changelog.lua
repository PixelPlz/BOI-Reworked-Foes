...
- Removed the telepills effect from Lust (and the Fool card effect for champion Lust)
...
- Pink Cage can no longer spawn Vises (they'd just die anyways)
...
- New sprites for Death's (the boss) scythes
...
- Fixed Rag Mega not killing Raglings on death like in vanilla
